...
if __name__ == '__main__':
    ...
    parser.add_argument("--input-csv", required=True, type=str,
                        help="Where to load in the new notes.")
    parser.add_argument("--input-annotation-csv", type=str,
                        help="Where to load in the MIMIC-IV annotations.")
    parser.add_argument("--output-csv", required=True, type=str,
                        help="Where to store the notes with new tags")
    parser.add_argument("--type", required=True, type=str,
                        choices=['mimic-iii', 'mimic-iv'], help="Running on MIMIC-III or IV text?")
    ...
    if args.type == 'mimic-iv':
        ...
        ids_offsets['note_id'] = ids_offsets['note_id'].astype(str)
